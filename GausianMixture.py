...
# Using the Gausian Mixture Algorithm
ms = GaussianMixture(n_components=3)
ms.fit(customers_normalized)
labels = ms.predict(customers_normalized)
...
# Visualise clusters for Gausian Mixture Algorithm
